...
def test_volume_of_cube()
  vol1 = volume_of_cube(1)
  vol3 = volume_of_cube(3)
  assert_equal(1, vol1)
  assert_equal(27, vol3)
end

  # #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    result_r3 = volume_of_sphere(3)
    result_r5 = volume_of_sphere(5)
    assert_equal(113.1, result_r3)
    assert_equal(523.6, result_r5)
  end

  # #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    celsius_freeze = fahrenheit_to_celsius(32) 
    celsius_boil = fahrenheit_to_celsius(212)
    assert_equal(0, celsius_freeze)
    assert_equal(100, celsius_boil)
  end
end
